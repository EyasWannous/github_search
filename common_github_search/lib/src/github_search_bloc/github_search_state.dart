...
final class SearchStateLoading extends GithubSearchState {
  const SearchStateLoading(this.items);

  final List<SearchResultItem>? items;

  @override
  List<Object> get props => items != null ? [items!] : [];

  @override
  String toString() => items != null
      ? 'SearchStateLoading { items: ${items!.length} }'
      : 'SearchStateLoading { items: empty }';
}
